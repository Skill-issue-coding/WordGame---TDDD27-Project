...
- **Swedish Stopwords:** The list of swedish stopwords (`preprocessing/stoppord.csv`) is sourced from [peterdalle/svensktext](https://github.com/peterdalle/svensktext) repository.

- **Common Swedish Words and Frequency:** The list of swedish words and frequency (`preprocessing/korp/`) is sourced from [spraakbanken.gu.se/](https://spraakbanken.gu.se/) selected (ord, grundform, _namn, namntyp_, ordklass).

- **Kelly:** The list of Kelly swedish words (`preprocessing/kelly.xml`) is sourced from [spraakbanken.gu.se/](https://spraakbanken.gu.se/en/resources/kelly).

- **Popular Companies:** The list of popular companies (`preprocessing/companies`) is sourced from [companiesmarketcap.com/](https://companiesmarketcap.com/), [kaggle.com/worlds-biggest-companies-dataset](https://www.kaggle.com/datasets/marshuu/worlds-biggest-companies-dataset?resource=download).

- **Celebrities:** The list of celebrities (`preprocessing/other`) is sourced from [kaggle.com/datasets/madhuripanchakshri/top-10000-celebrities-dataset](https://www.kaggle.com/datasets/madhuripanchakshri/top-10000-celebrities-dataset).
