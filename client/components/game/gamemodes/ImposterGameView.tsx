        ...
        {phase === "reveal" && (
          <PhaseTransition phaseKey="reveal">
            <div className="w-full max-w-md text-center">
              ...
              <p className={cn("text-sm mb-4 uppercase tracking-wider font-display font-bold whitespace-pre-line", isImpostor ? "text-destructive animate-pulse" : "text-muted-foreground")}>
          ...
          <PhaseTransition phaseKey="vote">
            <div className="w-full max-w-md">
              ...
              <div className="mt-6 text-center mb-6">
                ...
                <p className="text-muted-foreground text-sm font-display font-semibold">Vem är impostern?</p>
              </div>
