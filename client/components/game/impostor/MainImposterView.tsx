...
export const MainImpostorView = () => {
  ...
  if (!isReady) {
    ...
    return (
      <motion.div key="get-ready" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="flex flex-col items-center justify-center pt-20 gap-4">
  ...
  return (
    <div className="pt-5">
      <AnimatePresence mode="wait">
        {phase === "show_word" && <RevealPhase key="show_word" />}
