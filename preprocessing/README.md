...
2. **FastText Model:** Download the Swedish fastText model [(`cc.sv.300.bin`)](https://fasttext.cc/docs/en/crawl-vectors.html) and place it in the `preprocessing/` root.
